...
- This Luts where tailored using the colour rendition of an iMac Retina monitor with a display colur profile of HD 709-A https://youtu.be/YwjLuUR51gE?feature=shared Given the crazy situation that everyone (not professionals) use a wide variety of different consumer monitor types with its own contrast and colour pallete profiles I truly have no idea how good or totally horrible anyone may see the LUTs results, be advised.
