...
# INSTRUCTIONS
To download the LUTs simply click over the .zip in the file menu above and then click in the download button option located in the upper right corner.
...
- This Luts where tailored using the colour rendition of an iMac Retina monitor with a display colur profile of HD 709-A https://youtu.be/YwjLuUR51gE?feature=shared Given the crazy situation that everyone (not professionals) use a wide variety of different consumer monitor types with its own contrast and colour profiles I truly have no idea how good or totally horrible anyone may see the LUTs results, be advised.
